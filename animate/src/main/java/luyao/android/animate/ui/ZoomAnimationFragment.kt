...
import luyao.android.animate.databinding.FragmentZoomBinding
 ...
 * on 2020/6/10 13:47
 */
class ZoomAnimationFragment : Fragment(R.layout.fragment_zoom) {

    private val binding by viewBindings(FragmentZoomBinding::bind)
    ...
    private fun zoomView() {
        ...
        binding.expandedImage.setImageResource(R.mipmap.ic_launcher)
        ...
        // properties (X, Y).
        binding.thumbButton1.getGlobalVisibleRect(startBoundsInt)
